...
file = uproot.open("/N/project/phonon/PHONON_Bkgnds/job_submission/multisim/7333558/sum_planargamma_scintillator.root")
tree = file["Primary"]
...
plt.grid()
plt.savefig("GammaTransfer_FullScintillator_planargammas_FracColorBar.pdf")
plt.show()
...
plt.grid()
plt.savefig("test_efficiency_scintillator_gammas.pdf")
plt.show()
