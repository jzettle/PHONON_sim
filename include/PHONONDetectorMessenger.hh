...
#ifndef PHONONDetectorMessenger_h
#define PHONONDetectorMessenger_h 1
...
class PHONONDetectorMessenger: public G4UImessenger
{
  public:
    PHONONDetectorMessenger(PHONONDetectorConstruction* );
    virtual ~PHONONDetectorMessenger();
