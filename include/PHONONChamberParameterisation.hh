...
#ifndef PHONONChamberParameterisation_h
#define PHONONChamberParameterisation_h 1
...
class PHONONChamberParameterisation : public G4VPVParameterisation
{ 
  public:
  
    PHONONChamberParameterisation(G4int    noChambers, 
                              G4double startZ, 
                              G4double spacing,
    ...
    virtual ~PHONONChamberParameterisation();
