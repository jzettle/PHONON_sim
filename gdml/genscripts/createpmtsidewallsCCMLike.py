...
total_height = 142.394 # 5 m height with 25 cm standoff on each end 
...
side_pos_out = open('../simple_target_detector/pmt_sidewall_positionsCCM.xml', 'w')
side_place_out = open('../simple_target_detector/pmt_sidewall_placementsCCM.xml', 'w')
...
side_rot_out = open('../simple_target_detector/pmt_sidewall_rotationsCCM.xml', 'w')
side_hole_out = open('../simple_target_detector/pmthole_sidewall_positionsCCM.xml', 'w')
side_hole_rot_out = open('../simple_target_detector/pmthole_sidewall_rotationsCCM.xml', 'w')
sidewall_refl_out = open('../simple_target_detector/refl_sidewall_subtractionsCCM.xml', 'w')

side_tpb_pos_out = open('../simple_target_detector/tpb_sidewall_positionsCCM.xml', 'w')
side_tpb_place_out = open('../simple_target_detector/tpb_sidewall_placementsCCM.xml', 'w')
side_tpb_rot_out = open('../simple_target_detector/tpb_sidewall_rotationsCCM.xml', 'w')
sidewall_tpb_out = open('../simple_target_detector/tpb_sidewall_subtractionsCCM.xml', 'w')
