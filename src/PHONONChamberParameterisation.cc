...
PHONONChamberParameterisation::PHONONChamberParameterisation(  
        G4int    noChambers, 
 ...
 : G4VPVParameterisation()
{
   ...
   if( noChambers > 0 ){
      ...
      if (spacingZ < widthChamber) {
         G4Exception("PHONONChamberParameterisation::PHONONChamberParameterisation()",
...
void PHONONChamberParameterisation::ComputeTransformation
...
void PHONONChamberParameterisation::ComputeDimensions
